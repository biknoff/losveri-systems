...
**Then the Council.** Life divided into twelve realms — *houses* — each to be governed by an agent, with a lord of lords above them: **Abraxas**, the agent the family actually talks to, by voice. Above them all stands **the Pillar** — five family principles, written as a constitution, that every agent advises through (serve the body first; the family eats first; words must match reality; every circle closes; sense is made together). Advice is the ceiling: agents inform, humans decide. Not all houses are built, and this repo says so plainly. Built today: **Chris** (2nd house, finances — voice-note an expense, it lands in the ledger), **Hanuman** (3rd house, the comms gate every agent routes through), **Fay** (6th house, domestic coordination in Haitian Creole), and **Fred** — the unconscious. The family interacts by voice, so Fred measures the voice itself: deterministic prosodic measurements from longitudinal recordings, and decisions can be gated on whether the speaker is at their **prosodic floor** — their baseline. Somatic context no text model has.

**Kubera is the 5th house — the lord of work.** Inside it, the work splits in two, named for a duality: **NUIT**, infinite possibility, and **HADIT**, the point where possibility collapses into action.
...
flowchart TB
    ...
    subgraph COUNCIL["THE COUNCIL — 12 houses, one lord of lords"]
        ABX["ABRAXAS<br/>lord of lords · voice interface"]
        FRED["FRED · the unconscious<br/>prosodic floor gates decisions"]
        CHRIS["Chris · finances"]
        HAN["Hanuman · comms gate"]
        FAY["Fay · domestic"]
        KUB["KUBERA · 5th house<br/>lord of work"]
